...
from domain.spire_ais_data import SpireAisData
from domain.vessel import Vessel
from domain.vessel_data import VesselData
from domain.vessel_voyage import VesselVoyage
from infra.repositories.repository_spire_ais_data import SpireAisDataRepository
from infra.repositories.repository_task_execution import TaskExecutionRepository
from infra.repositories.repository_vessel_data import VesselDataRepository
from infra.repositories.repository_vessel_voyage import VesselVoyageRepository
from logger import logger
from pydantic import ValidationError
from typing import Union


def map_ais_data_to_vessel_data(ais_data: SpireAisData, vessel: Vessel) -> VesselData:
    return VesselData(
...
def map_ais_data_to_vessel_voyage(ais_data: SpireAisData, vessel: Vessel) -> Union[VesselVoyage | None]:
    try:
        return VesselVoyage(
        ...
        logger.debug("Données de voyage invalides")
        return None
